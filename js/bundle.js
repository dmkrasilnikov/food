...
function calc() {
  ...
  (function () {
    var sex = 'female',
        ...
        age,
        ratio = 1.375;
    var ansContainer = document.querySelector('.calculating__result span'),
    ...
    function calc() {
      ...
      if (sex && height && weight && age && ratio) {
        if (sex == 'male') {
          res = Math.round((66.5 + 13.75 * weight + 5.003 * height - 6.775 * age) * ratio); // console.log(res);
        } else if (sex == 'female') {
          res = Math.round((655.1 + 9.563 * weight + 1.85 * height - 4.676 * age) * ratio); // console.log(res);
        }
      }
    ...
    btns.forEach(function (btn) {
      btn.addEventListener('click', function (e) {
        ...
        e.target.parentElement.querySelectorAll('.calculating__choose-item').forEach(function (item) {
...
function clearForm() {
  (0,_modal__WEBPACK_IMPORTED_MODULE_6__.clearPrevModalMessage)();
  var oldContent = document.querySelector('.modal .modal__content');
...
function postForm(form) {
  ...
  postData('http://localhost:3000/requests', JSON.stringify(data)).then(function (data) {
    console.log(data);
    (0,_modal__WEBPACK_IMPORTED_MODULE_6__.showModalMessage)(_modal__WEBPACK_IMPORTED_MODULE_6__.formSubmitMessages.success, 3000);
  })["catch"](function () {
    (0,_modal__WEBPACK_IMPORTED_MODULE_6__.showModalMessage)(_modal__WEBPACK_IMPORTED_MODULE_6__.formSubmitMessages.failure, 3000);
  })["finally"](function () {
    form.reset();
  });
}
...
function menu() {
  ...
  var Menu = /*#__PURE__*/function () {
    function Menu(title, descr, src, alt, price, parentSelector) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "clearPrevModalMessage": () => (/* binding */ clearPrevModalMessage),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "formSubmitMessages": () => (/* binding */ formSubmitMessages),
/* harmony export */   "showModalMessage": () => (/* binding */ showModalMessage)
/* harmony export */ });
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./forms */ "./js/modules/forms.js");





var modalTimerId = setTimeout(showModal, 5000);
var formSubmitMessages = {
...
function clearPrevModalMessage() {
  var prevModalMessage = document.querySelector('.modal__message');
...
var timerForCloseModalForm;
forms.forEach(function (form) {
  form.addEventListener('submit', function (event) {
    event.preventDefault();
    _forms__WEBPACK_IMPORTED_MODULE_4__.postForm(event.target);
  });
});
...
function modal() {
  ...
  function closeModal() {
    _forms__WEBPACK_IMPORTED_MODULE_4__.clearForm();
...
function slider(_ref) {
  ...
  var mySlider = function mySlider(sliderSelector, slideSelector) {
  ...
  var mySlider2 = function mySlider2(_ref2) {
    var sliderSelector = _ref2.sliderSelector,
        slideSelector = _ref2.slideSelector;
    var slider = document.querySelector(sliderSelector),
        slideList = slider.querySelectorAll(slideSelector),
        total = slideList.length,
        currentContainer = slider.querySelector('#current'),
    ...
    var current = 0;
    var offset = 0; // const slideWidth = +window.getComputedStyle(sliderWrapper).width.slice(0,window.getComputedStyle(sliderWrapper).width.length-2);

    var slideWidth = +window.getComputedStyle(sliderWrapper).width.replace(/\D/g, '');
    slideList.forEach(function (slide) {
...
function timer() {
  ...
  var customeTimer = {
    ...
    getTimeRemain: function getTimeRemain(endtime) {
    ...
    make: function make(selector, endTime) {
      var data = customeTimer.getTimeRemain(endTime),
